...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_86350496d874", "created_at": "2026-07-20T10:22:06+00:00", "title": "Finite precision and deterministic order"}
-->
Enumerates nonnegative ordered-map monoids; retains NaN exclusion and fixed recurrence-consistent evaluation. Signed multiplier and Float32 reassociation are negative controls.


---
<!-- trackio-cell
{"type": "code", "id": "cell_0691adcb3c1a", "created_at": "2026-07-20T10:22:07+00:00", "title": "Gate verifier", "command": [".venv/bin/python", "repro/src/verify_claims.py"], "exit_code": 0, "duration_s": 0.037}
-->
````bash
...
````output
{
  ...
  "live_claim_count": 3,
  "claim_1_wreath_framework": true,
  "claim_2_deterministic_finite_precision": true,
  "claim_3_rederivation_and_correction": true,
  "decisive_claims": 3,
  "earned_points": 6,
